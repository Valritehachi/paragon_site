...
const serviceGroups = [
  {
    title: "Network Adequacy Oversight (Prime Role)",
    items: [
      "Verification of geographic network coverage",
      "Monitoring access-to-care compliance",
      "Oversight of PBM network performance",
    ],
  },
  ...
  {
    title: "Financial Reconciliation (Prime-Level Oversight)",
    items: [
      "Invoice validation",
      "Cost transparency",
      "Reconciliation of financial variances",
    ],
  },

   {
    title: "Risk Mitigation & Vendor Governance",
    items: [
      "Monitoring vendor performance",
      "Identifying compliance risks",
      "Escalation of issues affecting federal operations",
